...
get3w 支持插件功能，你可以很容易的加入自己的代码。

<div class="ct-alert ct-my-lg ct-left --info">
  <div class="inner">
    <i class="fa fa-info-circle ct-color-yellow-a200"></i>
    <div class="content">
      <span class="ct-h6">在 GitHub Pages 使用插件</span><br>
      <a href="http://pages.github.com/" class="ct-color-yellow-a200">GitHub Pages</a> 是由 get3w 提供技术支持的，考虑到安全因素，所有的 Pages 通过 <code>--safe</code> 选项禁用了插件功能，因此如果你的网站部署在 Github Pages ，那么你的插件不会工作。<br>
      不过仍然有办法发布到 GitHub Pages，你只需在本地做一些转换，并把生成好的文件上传到 Github 替代 get3w 就可以了。
    </div>
  </div>
</div>
...
在网站根下目录建立 `_plugins` 文件夹，插件放在这里即可。 get3w 运行之前，会加载此目录下所有以 `*.rb` 结尾的文件。
...
<div class="ct-alert ct-mb-lg ct-left --info">
  <div class="inner">
    <i class="fa fa-info-circle ct-color-yellow-a200"></i>
    <div class="content">
      <span class="ct-h6">记住你的 YAML 头信息</span><br>
      get3w 只会转换带有 YAML 头信息的文件，即使你使用了插件也不行。
    </div>
  </div>
</div>
...
<div class="ct-alert ct-my-lg ct-left --info">
  <div class="inner">
    <i class="fa fa-info-circle ct-color-yellow-a200"></i>
    <div class="content">
      <span class="ct-h6">期待你的作品</span><br>
      如果你有一个 Jekyll 插件并且愿意加到这个列表中来，可以<a href="/contributing/" class="ct-color-yellow-a200">阅读此须知</a>，并参照着来做。
    </div>
  </div>
</div>
